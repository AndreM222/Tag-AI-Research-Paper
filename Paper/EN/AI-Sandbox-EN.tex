...
\usepackage[
    ...
    pdfsubject={Multi-agent artificial intelligence using evolutionary and reinforcement learning},
...
\headerBlock{
    ...
    Presented at Penn State University (Sigma Xi)\textsuperscript{2}
}
\begin{center}
	\researchTitle{Tag AI-Sandbox}

	\authorInfo{Roberto Andre Mossi Milla}{
...
\begin{Form}
    ...
    \footnotetext[1]{ASEE publication available at \citeurl{AITagSandboxPaper}}

    \footnotetext[2]{Presented at the Penn State University Sigma Xi Research Exhibition
    (\url{https://sites.psu.edu/behrendsigmaxi2025/2025/03/11/tag-ai-sandbox/})}

    \ClearShipoutPicture

	\midSection{Introduction}
	\midSectionContent{
	...
	\midSectionContent{
		...
		\imageBlock{../../IMG/ExitsPreview.png}{Rooms Setup}
		\imageBlock[0.25]{../../IMG/ProceduralPreviewPic.png}{World Generator Preview}

		\midSubSection{Collision Detection}
		\midSubSectionContent{
            ...
            \begin{bulletBlockContent}
                \bulletBlockItem{General Collision} For the general collision all we require is to get any space that it is trying to spawn and
    ...
    \begin{codeBlock}{cpp}[Collision Sweep Check]
...
if (Cast<AMaster_Room>(Hit.GetActor())) return true;
	...
	\midSectionContent{
        \begin{bulletBlockContent}
            \bulletBlockItem{Dimension Spawn} Based on the dimensions of the room it is trying to spawn, we require to find if there is
    ...
    \begin{codeBlock}{cpp}[Dimension Spawner]
// Make temporary room
...
FCollisionShape box = FCollisionShape::MakeBox(BoxDimensions);
	...
	\midSubSection{Encapsulating World}
	\midSubSectionContent{
		...
		\imageBlock[0.4]{../../IMG/MasterRoomChildrenPreview.png}{Creation of Rooms}
	}
	...
	\midSubSectionContent{
		...
		\imageBlock{../../IMG/SpawnPointsPreview.png}{Props Spawner}

		\imageBlock{../../IMG/PropsPreview.png}{Props Settings}
	}

	\midSubSection{Props and Spawners}
	\midSubSectionContent{
	...
	\midSectionContent{
		...
		\imageBlock[0.6]{../../IMG/Teams-Picture-Preview.png}{Character Setup}

		\midSubSection{States}
		\midSubSectionContent{
			...
			\begin{bulletBlockContent}
				\bulletBlockItem{Used} Is currently being used for some kind of interaction.
				\bulletBlockItem{Planned} Is ready to be used but has not combined it with the logic to activate it.
			\end{bulletBlockContent}
	...
	\midSectionContent{
		...
		\imageBlock[0.4]{../../IMG/ActionPreview.png}{Previews Of Actions}
	}

	\midSection{Decision Making Through Genomes}
	\midSectionContent{
		...
		\midSubSection{Genetic Algorithm}
		\midSubSectionContent{
			...
			\imageBlock[0.15]{../../IMG/GeneticAlgorithm.png}{Genetic Algorithm}
		}

		\midSubSection{NEAT Algorithm}
		\midSubSectionContent{
			...
			\imageBlock[0.15]{../../IMG/NeatAlgorithm.png}{NEAT Algorithm}
		}
		...
		\midSubSectionContent{
			...
			\imageBlock[0.35]{../../IMG/TracingSense.png}{Previews Of Senses}
